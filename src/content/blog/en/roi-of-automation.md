...
| Gain | How to size it | Worked example |
|------|----------------|----------------|
| Time saved | Hours/week × weeks/year × hourly cost | 5 h × 50 wk × €40 = **€10,000/yr** |
| Errors avoided | Error rate × volume × cost per error | 2% × 1,000 × €50 = **€1,000/yr** |
| Faster processing | Time saved × volume × value of speed | Faster invoicing → faster payment |
| Scalability | Volume you can absorb without hiring | Hard to quantify, still real |
...
If invoices are your bottleneck, the [invoice-reader demo](/en/projects/) shows the time-saved gain on real documents.
...
Want a second opinion on the numbers for your process? [Book a free 20-minute call](https://cal.com/tobias-leinss/strategymeeting) and we'll size it together. If you're still deciding whether it's time, the [5 signs your business needs automation](/en/blog/5-signs-your-business-needs-automation/) is a fast gut-check.
